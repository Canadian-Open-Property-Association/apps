...
export default function FurnisherFieldForm({ field, onSave, onClose }: FurnisherFieldFormProps) {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.name?.trim()) {
      ...
      newErrors.name = 'Claim name must start with a letter and contain only letters, numbers, and underscores';
    }
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-end pb-2">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">Required claim</span>
              </label>
            </div>
          </div>
